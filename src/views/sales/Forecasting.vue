          ...
          <ol class="flex items-center space-x-4">
            ...
            <li>
              <div class="flex items-center">
                ...
                <span class="ml-4 text-sm font-medium text-gray-500">Sales Platform</span>
              </div>
            </li>
            <li>
              <div class="flex items-center">
      ...
      <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex items-center space-x-4">
          ...
          <select
            ...
            class="px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
          >
          ...
          <button
            ...
            class="bg-green-600 hover:bg-green-700 disabled:bg-green-400 text-white px-4 py-2 rounded-md font-medium transition-colors flex items-center"
          >
            ...
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-sm text-gray-500">
                  from last {{ selectedTimeframe === 'monthly' ? 'month' : 'quarter' }}
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p :class="getAccuracyColor(forecastData.average_probability)" class="text-2xl font-bold">
          ...
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-gray-900">{{ formatNumber(forecastData.total_deals) }}</p>
                <p class="text-sm text-gray-500">
                  from last month
                </p>
              </div>
