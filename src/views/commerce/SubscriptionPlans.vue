    ...
    <div class="bg-white shadow-xl border-b border-gray-200">
      <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-4xl font-bold text-gray-900 mb-2">Subscription Plans</h1>
            <p class="text-lg text-gray-600">Manage your subscription plans and pricing strategies</p>
          </div>
          <div class="flex items-center space-x-4">
            <button
              @click="refreshPlans"
              :disabled="subscriptionsStore.plansLoading"
              class="inline-flex items-center px-6 py-3 border border-gray-300 rounded-xl shadow-sm text-sm font-semibold text-gray-700 bg-white hover:bg-gray-50 hover:shadow-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50"
            >
          ...
          <div class="p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4 flex-1">
                ...
                <p class="text-3xl font-bold text-gray-900">{{ subscriptionsStore.plans.length }}</p>
                <p class="text-xs text-green-600 font-medium">+2 this month</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4 flex-1">
                ...
                <p class="text-3xl font-bold text-gray-900">{{ subscriptionsStore.activePlansCount || subscriptionsStore.plans.filter(p => p.active !== false).length }}</p>
                <p class="text-xs text-green-600 font-medium">100% active</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4 flex-1">
                ...
                <p class="text-3xl font-bold text-gray-900">${{ averagePrice }}</p>
                <p class="text-xs text-blue-600 font-medium">Per month</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white overflow-hidden shadow-xl rounded-2xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
          <div class="p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4 flex-1">
                <p class="text-sm font-medium text-gray-600">Stripe Synced</p>
                <p class="text-3xl font-bold text-gray-900">{{ stripeSyncedCount }}</p>
                <p class="text-xs text-purple-600 font-medium">Payment ready</p>
              </div>
            </div>
          </div>
        </div>
