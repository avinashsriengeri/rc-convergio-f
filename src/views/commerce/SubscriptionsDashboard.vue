<template>
  <div class="min-h-screen bg-gray-50" v-if="!hasError">
    ...
    <div class="bg-white shadow">
      <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-2xl font-bold text-gray-900">Subscriptions Dashboard</h1>
            <p class="mt-1 text-sm text-gray-500">Monitor and manage customer subscriptions</p>
          </div>
          <div class="flex items-center space-x-3">
            ...
            >
              <svg v-if="subscriptionsStore.subscriptionsLoading" class="animate-spin -ml-1 mr-2 h-4 w-4 text-gray-500" fill="none" viewBox="0 0 24 24">
    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
          <div class="p-6">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                ...
                <div class="ml-4">
                  <p class="text-sm font-medium text-green-700">Active Subscriptions</p>
                  <p class="text-2xl font-bold text-green-900">{{ subscriptionsStore.analytics?.activeSubscriptions || activeSubscriptionsCount }}</p>
                </div>
              </div>
        ...
        <!-- Total Revenue -->
        <div class="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
          <div class="p-6">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <div class="flex-shrink-0">
                ...
                <div class="ml-4">
                  ...
                  <p class="text-2xl font-bold text-blue-900">${{ formatCurrency(subscriptionsStore.analytics?.monthlyRecurringRevenue) }}</p>
                </div>
              </div>
              <div class="text-right">
        ...
        <!-- Conversion Rate -->
        <div class="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
          <div class="p-6">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <div class="flex-shrink-0">
                ...
                <div class="ml-4">
                  ...
                  <p class="text-2xl font-bold text-purple-900">{{ subscriptionsStore.analytics?.churnRate || '0.0' }}%</p>
                </div>
              </div>
              <div class="text-right">
        ...
        <!-- Average Order Value -->
        <div class="bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
          <div class="p-6">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <div class="flex-shrink-0">
                ...
                <div class="ml-4">
                  <p class="text-sm font-medium text-orange-700">Avg Order Value</p>
                  <p class="text-2xl font-bold text-orange-900">${{ formatCurrency(subscriptionsStore.analytics?.revenueThisMonth) }}</p>
                </div>
              </div>
              <div class="text-right">
          ...
          <div class="p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                ...
                <p class="text-xl font-semibold text-gray-900">{{ subscriptionsStore.analytics?.activeSubscriptions || '0' }}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
          <div class="p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <p class="text-sm font-medium text-gray-600">Payment Links</p>
                <p class="text-xl font-semibold text-gray-900">14</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="p-6">
            <div class="space-y-4">
              ...
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-semibold text-gray-900">${{ formatCurrency(subscriptionsStore.analytics?.monthlyRecurringRevenue) }}</span>
              </div>
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  ...
                  <span class="text-sm font-medium text-gray-700">Paid Revenue</span>
                </div>
                <span class="text-sm font-semibold text-gray-900">${{ formatCurrency(subscriptionsStore.analytics?.monthlyRecurringRevenue) }}</span>
              </div>
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  ...
                  <span class="text-sm font-medium text-gray-700">USD Revenue</span>
                </div>
                <span class="text-sm font-semibold text-gray-900">${{ formatCurrency(subscriptionsStore.analytics?.monthlyRecurringRevenue) }}</span>
              </div>
              ...
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-semibold text-gray-900">${{ formatCurrency(subscriptionsStore.analytics?.revenueThisMonth) }}</span>
              </div>
            </div>
          </div>
        </div>
  ...
  <div v-else class="min-h-screen bg-gray-50 flex items-center justify-center">
    <div class="text-center">
      ...
      <p class="text-gray-600 mb-4">There was an error loading the subscriptions dashboard.</p>
      <button 
        @click="retryLoad"
