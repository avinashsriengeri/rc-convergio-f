<template>
  <div
    class="hero-component relative group cursor-pointer"
  ...
  >
    ...
    <!-- Hero Content -->
    <div
      class="relative min-h-96 flex items-center justify-center py-20 px-8"
      :style="{
        backgroundImage: data.backgroundImage ? `url(${data.backgroundImage})` : 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
    ...
    >
      <div class="relative z-10 max-w-4xl">
        <h1 class="text-5xl font-bold text-white mb-4" v-html="data.title || 'Hero Title'"></h1>
        <p class="text-xl text-white/90 mb-8" v-html="data.subtitle || 'Hero Subtitle'"></p>
        <a
